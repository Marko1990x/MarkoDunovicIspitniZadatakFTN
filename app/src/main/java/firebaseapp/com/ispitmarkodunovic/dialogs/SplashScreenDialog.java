...
public class SplashScreenDialog extends AppCompatDialogFragment {
    // use the dial fragment class
    private EditText editTextPosition;
    private dialogPositionListener3 listener; // this is my interface
    ...
    public android.app.Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        builder.setView(view)
                .setTitle("Enter Time (in Seconds) For Splash Screen")
                .setCancelable(false)
                ...
                .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        listener.splashScreen(position); // this sends the data to the main activity
    ...
    public void onAttach(Context context) {
        ...
        try {
            listener = (dialogPositionListener3) context;
    ...
    public interface dialogPositionListener3{
        void splashScreen(String position);
    }
}

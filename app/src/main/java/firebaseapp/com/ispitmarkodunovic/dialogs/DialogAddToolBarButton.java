...
public class DialogAddToolBarButton extends AppCompatDialogFragment {
    // use the dial fragment class
    private EditText editTextPosition;
    private dialogPositionListener2 listener; // this is my interface
        ...
        builder.setView(view)
                ...
                .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        listener.addToList(position); // this sends the data to the main activity
    ...
    public void onAttach(Context context) {
        ...
        try {
            listener = (dialogPositionListener2) context;
    ...
    public interface dialogPositionListener2{
        void addToList(String position);
    }
}
